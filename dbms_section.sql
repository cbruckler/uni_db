...
CREATE TABLE `section` (
  ...
  CONSTRAINT `section_ibfk_2` FOREIGN KEY (`building`, `room_no`) REFERENCES `classroom` (`building`, `room_number`) ON DELETE SET NULL,
...
-- Dump completed on 2019-08-15 16:43:37
